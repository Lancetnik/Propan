...
def get_base_lang_config(lang: str):
    ...
    project_base_url = "https://lancetnik.github.io/Propan/"
    new_config = en_config.copy()
    new_config["site_url"] = en_config["site_url"] + f"{lang}/"
    new_config["theme"]["logo"] = project_base_url + en_config["theme"]["logo"]
    new_config["theme"]["favicon"] = project_base_url + en_config["theme"]["favicon"]
    ...
    for css in en_config["extra_css"]:
        if css.startswith("http"):
            ...
            extra_css.append(project_base_url + css)
    ...
    for js in en_config["extra_javascript"]:
        if js.startswith("http"):
            ...
            extra_js.append(project_base_url + js)
