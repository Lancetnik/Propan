...
exch = RabbitExchange("exch", auto_delete=True, type=ExchangeType.TOPIC)

queue_1 = RabbitQueue("test-q-1", auto_delete=True, routing_key="*.info")
queue_2 = RabbitQueue("test-q-2", auto_delete=True, routing_key="*.debug")
